...
const rclnodejs = require('/usr/local/lib/node_modules/rclnodejs');
const WebSocket = require('/usr/local/lib/node_modules/ws');
const Bridge = require('./lib/bridge.js');
const debug = require('/usr/local/lib/node_modules/debug')('/usr/local/lib/node_modules/ros2-web-bridge:index');
...
function createConnection(options) {
  if (options.address != null) {
    ...
    options.port = options.port || 8085;
